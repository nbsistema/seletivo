...
const SCRIPT_URL = import.meta.env.VITE_GOOGLE_SCRIPT_URL || 'https://script.google.com/macros/library/d/1lfVun4jtVF_rOFUZt7KbzuI05VTB1Hh6HIYmMQCaxbgTtCS9GVA9JsoY/3';
