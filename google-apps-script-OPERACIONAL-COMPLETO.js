// ============================================
// GOOGLE APPS SCRIPT - SISTEMA COMPLETO E OPERACIONAL
// ============================================
//
// INSTRUÇÕES:
// 1. Cole este código completo no Google Apps Script
// 2. Configure o SPREADSHEET_ID abaixo com o ID da sua planilha
// 3. Implante como Web App (Implantar > Nova implantação > Web App)
// 4. Escolha "Executar como: Eu" e "Quem tem acesso: Qualquer pessoa"
// 5. Copie a URL da Web App e cole no .env do projeto (VITE_GOOGLE_SCRIPT_URL)
//
// ============================================
